...
- **ContentHash Support**: Supporting Content Hash changes over time
- **L2 Name Support**: Adding visualization for ENS names on Layer 2 networks once ENSNode adds support
